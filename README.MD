# Test Automation framework Architecture using Java and Selenium WebDriver,Allure
[![Actions Status](https://github.com/akashgupta03/selenium-java-framework-with-allure-report.git
/workflows/Build%20and%20Test/badge.svg)](https://github.com/akashgupta03/selenium-java-framework-with-allure-report.git
/actions)
...
#### DriverManager class
The class [DriverManager](https://github.com/akashgupta03/selenium-java-framework-with-allure-report/blob/master/src/main/java/com/eliasnogueira/driver/DriverManager.java) 
create a `ThreadLocal` for the WebDriver instance, to make sure there's no conflict when we run it in parallel.

### BaseTest
This testing pattern was implemented on the [BaseWeb](https://github.com/akashgupta03/selenium-java-framework-with-allure-report.git
/blob/master/src/test/java/com/eliasnogueira/BaseWeb.java) 
...
important information, like the users, automatically generated by the factory [BookingDataFactory](https://github.com/akashgupta03/selenium-java-framework-with-allure-report.git
/blob/master/src/main/java/com/eliasnogueira/data/BookingDataFactory.java)
...
* [Configuration](https://github.com/akashgupta03/selenium-java-framework-with-allure-report/blob/master/src/main/java/com/eliasnogueira/config/Configuration.java)
* [ConfigurationManager](https://github.com/akashgupta03/selenium-java-framework-with-allure-report/blob/master/src/main/java/com/eliasnogueira/config/ConfigurationManager.java)
...
The [Booking](https://github.com/akashgupta03/selenium-java-framework-with-allure-report/blob/master/src/main/java/com/eliasnogueira/model/Booking.java) is the plain Java objects 
and the [BookingBuilder](https://github.com/akashgupta03/selenium-java-framework-with-allure-report/blob/master/src/main/java/com/eliasnogueira/model/BookingBuilder.java) is the builder class.

You can ses the use of the Builder pattern in the [BookingDataFactory](https://github.com/akashgupta03/selenium-java-framework-with-allure-report/blob/master/src/main/java/com/eliasnogueira/data/BookingDataFactory.java) class.
...
* open report run mvn allure:serve  